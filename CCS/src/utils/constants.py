...
DEFAULTS = {
    ...
    "common": {
        ...
        "backdoor": {
            "select_client": 1,#1为共谋攻击，2为持续攻击，3为随机选择
            "poison_client_ids": [1, 15, 23, 37, 46, 55, 69, 75, 97, 84],
            "poison_client_ratio": 0.1,
            "trigger_size": 4,#触发器大小
            "trigger_location": 2,#触发器位置，1为右下角，2为中央
            "poison_epoch": 500,
            "poison_method": 'badnet',#'badnet','bapfl','pfedba'，'dba','fcba','badpfl'
            "target_label": 7,
            "alpha_loss": 1,
            "BapFL_PGD": 0,
            "sigma": 0.01,
            "pFedBA_first_attack": 1,
            "pFedBA_learning_rate": 0.1,
            "defence_method": None, #若AT
            "aggerate":None,
            "sars_ratio": 300,
            "sars_epoch": 4,
            "flag_spa": 1,
